  ...
  return (
    <html>
      <body className="min-h-screen w-full flex items-center justify-center bg-black relative overflow-hidden">
        ...
        <div className="backdrop-blur-xl bg-gradient-to-br from-[#1a1a1a]/80 to-[var(--theme-panel-a)]/60
                        border border-white/5 shadow-[0_0_30px_rgb(var(--theme-glow-500)/0.08)]
