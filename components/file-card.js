    ...
    return (
        <div key={index} className="rounded-2xl bg-gradient-to-b from-[#222] to-purple-900/60 p-4 shadow-lg border border-white/10 backdrop-blur-md text-white">
            <div className="overflow-hidden rounded-xl mb-4">
                <div className="md:hidden rounded-xl border border-white/15 bg-white/[0.06] p-4 h-20 flex flex-col items-center justify-center text-center">
                    <p className="text-white/80 font-medium">click open to view more</p>
                </div>
